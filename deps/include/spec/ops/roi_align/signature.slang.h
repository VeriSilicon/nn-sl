...
DEFINE_SIGNATURE(f32_f32,
                 ...
                 TENSOR(BatchIndex, INT32, NO_QUANT),
...
DEFINE_SIGNATURE(f32_constbatchindex_f32,
                 TENSOR(Input, FP32, NO_QUANT),
                 TENSOR(Regions, FP32, NO_QUANT),
...
DEFINE_SIGNATURE(f16_constbatchindex_f16,
                 TENSOR(Input, FP16, NO_QUANT),
                 TENSOR(Regions, FP16, NO_QUANT),
                 TENSOR(BatchIndex, INT32, NO_QUANT, CONSTANT),
                 TENSOR(Output, FP16, NO_QUANT),
...
DEFINE_SIGNATURE(u8asymm_constbatchindex_u8asymm,
                 TENSOR(Input, UINT8, ASYMM),
                 TENSOR(Regions, UINT16, ASYMM),
                 TENSOR(BatchIndex, INT32, NO_QUANT, CONSTANT),
                 TENSOR(Output, UINT8, ASYMM),
...
DEFINE_SIGNATURE(i8asymm_constbatchindex_i8asymm,
                 TENSOR(Input, INT8, ASYMM),
                 TENSOR(Regions, UINT16, ASYMM),
                 TENSOR(BatchIndex, INT32, NO_QUANT, CONSTANT),
                 TENSOR(Output, INT8, ASYMM),
...
ADD_SIGNATURE(f32_f32,
              ...
              u8asymm_u8asymm,
              i8asymm_i8asymm,
              f32_constbatchindex_f32,
              f16_constbatchindex_f16,
              u8asymm_constbatchindex_u8asymm,
              i8asymm_constbatchindex_i8asymm)