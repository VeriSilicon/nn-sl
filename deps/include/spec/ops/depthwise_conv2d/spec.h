...
DECLARE_SCALAR_PARAM(Multiplier, REQUIRED)
DECLARE_SCALAR_PARAM(Activation, REQUIRED)
DECLARE_SCALAR_PARAM(Layout, REQUIRED)

DECLARE_SIGNATURE(
    Input, Kernel, Bias, Output, Stride, Dilation, PadType, Pad, Multiplier, Activation, Layout)

#include "signature.slang.h"
#include "rule.slang.h"
END_SPEC(depthwise_conv2d)
